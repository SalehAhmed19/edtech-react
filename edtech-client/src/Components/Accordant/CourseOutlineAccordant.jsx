export default function CourseOutlineAccordant({
  item,
  index,
  activeIndex,
  onToggle,
  ...
  return (
    <div className=" rounded-lg overflow-hidden cursor-pointer">
      ...
      <button
        ...
        } hover:bg-[#e0025b0e] hover:text-[#333] focus:outline-none transition duration-300 ease-in-out cursor-pointer my-2 rounded-lg border-b-2 border-[#333]`}
      ...
      >
        <div className="overflow-hidden">
          <div className="px-6 py-4 text-gray-700 bg-[#33323]">
            {item?.content}
          </div>
        </div>
      </div>
