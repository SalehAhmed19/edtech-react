    ...
    <div className=" rounded-lg overflow-hidden cursor-pointer">
      ...
      <button
        className={`flex justify-between items-center w-full px-6 py-3 ${
          isOpen ? "bg-[#CE2823] text-[#fff]" : "bg-white text-black"
        } hover:bg-[#e0025b0e] hover:text-[#333] focus:outline-none transition duration-300 ease-in-out cursor-pointer my-2 rounded-lg`}
